...
class User_admin extends MY_Controller {
    ...
    function index() {
        ...
        if ($this->session->userdata('user_group') && !$this->session->userdata('is_admin')) {
            $where['id'] = $this->session->userdata('user_id');
            $this->data['dataList'] = $this->user_admin_model->getData('', '', $where, 'where');
        } else {

            $this->data['dataList'] = $this->user_admin_model->getData('');
        }

        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body">
                <div class="clearfix">
                    ...
                    <div class="btn-group">
                        <button class="btn green" onclick="javascript:delete_data('<?= base_url() ?>','<?php echo $this->router->fetch_class();?>');">
                ...
                <div class="row-fluid">
                    <div class="">
                        <div class="dataTables_filter">
                            <label>Search: <input type="text" field="menu_name,content_data" id="search_desc" name="search_desc" onkeyup="javascript:searchdata('content_list','<?=base_url()?>','<?php echo $this->router->fetch_class();?>',this);" class="m-wrap small"></label>
                        </div>
                    </div>
                </div>
                        ...
                        if ($contentData) {
                            foreach ($contentData as $index => $value) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="#" onclick="javascript:add_data('<?= base_url() ?>','<?php echo $this->router->fetch_class();?>', '<?= $value['id'] ?>');"><?php echo $value['menu_name']; ?></a></td>
                                    <!--<td><?php // echo isset($value['content_data']) ? $value['content_data'] : ''; ?></td>-->
                                </tr>
                                <?php
                            }
                        }
